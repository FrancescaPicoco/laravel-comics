...
return [
    ...
    "icons" => [
        [ 
            "icn"=> "../asset/img/buy-comics-digital-comics.png",
            "description" => "DIGITAL COMICS"
        ],
        [
            "icn"=> "../asset/img/buy-comics-merchandise.png",
            "description" => "DC MERCHANDISE"
        ],
        [
            "icn"=> "../asset/img/buy-comics-subscriptions.png",
            "description" => "SUBSCRIPTIONS"
        ],
        [
            "icn"=>"../asset/img/buy-comics-shop-locator.png",
